...
require HT_HF_PATH . 'inc/elementor/class-boostify-hf-plugin.php';
...
abstract class Module_Base {
	...
	public function get_assets_url() {
		return HT_HF_PATH . $this->get_name() . '/assets/';
	}
	...
	public function init_widgets() {
		$widget_manager = Boostify_Hf_Plugin::elementor()->widgets_manager;
